...
def plot_1(series):
    ...
    plot_data1 = PlotData(V, I, title="ВАХ диода, прямая ветвь", x_name='U, B', y_name='I, мА')
    d1 = Drawer()
    d1.add_figure(plot_data1)
    plot_data2 = PlotData(V2, I2, title="ВАХ диода, обратная ветвь", x_name='U, B', y_name='I, мА')
...
def plot_3(series):
    ...
    pd1 = PlotData(V, ln_i, title='Зависимость ln(I) от напряжения на диоде U',
                   x_name='U, B',
                   y_name='ln(I)')
    d = Drawer()
...
def plot_4(series):
    ...
    pd1 = PlotData(V, c_base, title='Зависимость барьерной ёмкости конденсатора при обратном подключении',
                   x_name="U, B",
                   y_name="Сб, нФ")
...
def plot_5(series):
    ...
    pd = PlotData(T, U, x_error=sT, y_error=sU, title="Зависимость напряжения на диоде от температуры",
                  x_name="T, K", y_name="U, B")
