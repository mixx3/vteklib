...
def plot1():
    ...
    pld2 = PlotData(
        T,
        P2,
        title="Зависимости давлений на концах капилляра от времени",
        x_name="T, c",
        y_name="P, Па",
        label="P2(t)",
    )
...
def plot4():
    ...
    P5 = P1[0:90]
    pld = PlotData(P5, L1, title="", label="λ1 эксп", x_name="P1, Па", y_name="λ1, м")
    pld3 = PlotData(P5, L2, title="", label="λ2 эксп", x_name="P1, Па", y_name="λ2, м")
    pld4 = PlotData(
        P5,
        L2_theory,
    ...
    pld2 = PlotData(
        P5, L1_theory, title="", label="λ1 теор", x_name="P1, Па", y_name="λ1, м"
    )
...
def plot5():
    ...
    p5 = P2[5:90]
    pld = PlotData(p5, S, title="", x_name="P2, Па", y_name="S, м³/с", label="S эксп")
    pld2 = PlotData(
        p5,
        S_theor,
