...
def plot_2():
    ...
    pd = PlotData(
        d,
        l12,
        title="Зависимость взаимной индукции катушек от расстояния между ними",
        label="L12(d)",
        x_name="x, см",
        y_name="L12, мГн",
    )
...
def plot_3():
    ...
    pd = PlotData(
        d,
        k,
        title="Зависимость коэффициента связи катушек от расстояния между ними",
        label="K(d)",
        x_name="x, см",
        y_name="K",
    )
...
def plot_4():
    ...
    pd = PlotData(
        x,
        y,
        title="Зависимость разности квадратов частот от 2/Cсв",
        label="f022-f012(2/Cсв)",
        y_name="f022-f012, 10^8 Гц2",
        x_name="2/Cсв, мкФ-1",
    )
    d = Drawer()
...
def plot_5():
    ...
    pd1 = PlotData(
        k,
        f1_e,
        title="Зависимость резоенансных частот от коэффициента связи K",
        label="f1exp",
        x_name="",
        y_name="f, Гц",
    )
